...
import com.bianyiit.service.ReportService;
...
public class ReportController {
    ...
    public Result getMemberReport() throws Exception {
        ...
        instance.add(Calendar.MONTH,-12);//根据当前的日期时间，减去12个月
        ...
        map.put("months",list);
        List<Integer> count = memberService.getMemberByMonth(list);
     ...
     * @return
     */
    @RequestMapping("/exportBusinessReport4Excel")//exportBusinessReport
